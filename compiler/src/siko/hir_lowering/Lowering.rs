use crate::siko::{
    ...
    qualifiedname::builtins::{
        getArrayTypeName, getBoolTypeName, getI32TypeName, getI64TypeName, getI8TypeName, getIntTypeName,
        getU16TypeName, getU32TypeName, getU64TypeName, getU8TypeName,
    },
};
