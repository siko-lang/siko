...
# -fno-strict-aliasing: enum payloads live in uint buffers accessed through
# casted pointers (generated by lower-enums), which is type punning.
exec clang -fno-optimize-sibling-calls -fno-strict-aliasing -Wno-unused-value -Wno-pointer-sign -Wno-incompatible-pointer-types -x c - -o "$output" $opt_flag $san_flags $gc_flags
