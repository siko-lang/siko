...
block0:
   ...
   call void @llvm.memcpy.p0.p0.i64(ptr align 4 %a_0, ptr align 4 %i_0_1, i64 8, i1 false)
   call void @llvm.memcpy.p0.p0.i64(ptr align 4 %i_0_3, ptr align 4 %a_0, i64 8, i1 false)
   br label %block2
block1:
   call void @llvm.memcpy.p0.p0.i64(ptr align 4 %i_1_1, ptr align 4 %match_var_1, i64 0, i1 false)
...
block4:
   ...
   call void @llvm.memcpy.p0.p0.i64(ptr align 4 %match_var_1, ptr align 4 %i_4_1, i64 0, i1 false)
   br label %block1
block5:
...
block6:
   ...
   call void @llvm.memcpy.p0.p0.i64(ptr align 4 %match_var_1, ptr align 4 %i_6_1, i64 0, i1 false)
   br label %block1
}
...
block0:
   ...
   call void @llvm.memcpy.p0.p0.i64(ptr align 4 %fn_result, ptr align 4 %i_0_2, i64 8, i1 false)
   ret void
}
