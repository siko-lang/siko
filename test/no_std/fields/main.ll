...
block0:
   ...
   %b0i5 = alloca %struct.Main_Bool, align 4
   %b0i4 = alloca %struct.Main_Container_Main_Bool, align 4
   %a_0 = alloca %struct.Main_Container_Main_Bool, align 4
   %b0i2 = alloca %struct.Main_Container_Main_Bool, align 4
   %b0i1 = alloca %struct.Main_Bool, align 4
   call void @Main_Bool_True(ptr %b0i1)
   call void @Main_Container_Main_Bool(ptr %b0i1, ptr %b0i2)
   ...
   call void @Main_other_Main_Bool(ptr %b0i4, ptr %b0i5)
...
block0:
   %b0i1 = alloca %struct.Main_Container_Main_Bool, align 4
   call void @llvm.memcpy.p0.p0.i64(ptr align 4 %b0i1, ptr align 4 %c, i64 4, i1 false)
   %b0i2 = getelementptr inbounds %struct.Main_Container_Main_Bool, ptr %b0i1, i32 0, i32 0
