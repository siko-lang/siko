...
block0:
   ...
   call void @llvm.memcpy.p0.p0.i64(ptr align 4 %item, ptr align 4 %field0, i8 4, i1 false)
...
block0:
   ...
   call void @llvm.memcpy.p0.p0.i64(ptr align 4 %a_0, ptr align 4 %i_0_2, i8 4, i1 false)
   call void @llvm.memcpy.p0.p0.i64(ptr align 4 %i_0_4, ptr align 4 %a_0, i8 4, i1 false)
   call void @Main_other_Main_Bool(ptr %i_0_4, ptr %i_0_5)
   call void @llvm.memcpy.p0.p0.i64(ptr align 4 %b_1, ptr align 4 %i_0_5, i8 4, i1 false)
   call void @siko_Tuple_(ptr %i_0_7)
   call void @llvm.memcpy.p0.p0.i64(ptr align 4 %fn_result, ptr align 4 %i_0_7, i8 0, i1 false)
   ret void
}
...
block0:
   ...
   call void @llvm.memcpy.p0.p0.i64(ptr align 4 %fn_result, ptr align 4 %i_0_2, i8 4, i1 false)
   ret void
}
