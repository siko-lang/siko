...
block0:
   %i_0_5 = alloca %struct.siko_Tuple_, align 4
   %i_0_4 = alloca %struct.siko_Tuple_, align 4
   ...
   call void @Int_Int_lessThan(ptr %i_0_3, ptr %i_0_1, ptr %i_0_4)
   call void @siko_Tuple_(ptr %i_0_5)
