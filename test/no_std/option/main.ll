...
block0:
   ...
   call void @llvm.memcpy.p0.p0.i64(ptr align 4 %a_0, ptr align 4 %i_0_2, i64 8, i1 false)
   call void @llvm.memcpy.p0.p0.i64(ptr align 4 %i_0_4, ptr align 4 %a_0, i64 8, i1 false)
   br label %block2
block1:
   call void @llvm.memcpy.p0.p0.i64(ptr align 4 %i_1_1, ptr align 4 %match_var_1, i64 4, i1 false)
   call void @Main_Option_None_Main_Bool(ptr %i_1_2)
   call void @llvm.memcpy.p0.p0.i64(ptr align 4 %a_3, ptr align 4 %i_1_2, i64 8, i1 false)
   call void @llvm.memcpy.p0.p0.i64(ptr align 4 %i_1_4, ptr align 4 %a_3, i64 8, i1 false)
   br label %block8
block2:
...
block4:
   ...
   call void @llvm.memcpy.p0.p0.i64(ptr align 4 %match_var_1, ptr align 4 %i_4_1, i64 4, i1 false)
   br label %block1
block5:
   ...
   br label %block6
block6:
   call void @llvm.memcpy.p0.p0.i64(ptr align 4 %a_2, ptr align 4 %i_5_2, i64 4, i1 false)
   call void @llvm.memcpy.p0.p0.i64(ptr align 4 %i_6_2, ptr align 4 %a_2, i64 4, i1 false)
   call void @llvm.memcpy.p0.p0.i64(ptr align 4 %match_var_1, ptr align 4 %i_6_2, i64 4, i1 false)
   br label %block1
block7:
   call void @llvm.memcpy.p0.p0.i64(ptr align 4 %i_7_1, ptr align 4 %match_var_4, i64 4, i1 false)
   call void @siko_Tuple_(ptr %i_7_2)
   call void @llvm.memcpy.p0.p0.i64(ptr align 4 %fn_result, ptr align 4 %i_7_2, i64 0, i1 false)
   ret void
block8:
...
block10:
   ...
   call void @llvm.memcpy.p0.p0.i64(ptr align 4 %match_var_4, ptr align 4 %i_10_1, i64 4, i1 false)
   br label %block7
block11:
   ...
   br label %block12
block12:
   call void @llvm.memcpy.p0.p0.i64(ptr align 4 %a_5, ptr align 4 %i_11_2, i64 4, i1 false)
   call void @llvm.memcpy.p0.p0.i64(ptr align 4 %i_12_2, ptr align 4 %a_5, i64 4, i1 false)
   call void @llvm.memcpy.p0.p0.i64(ptr align 4 %match_var_4, ptr align 4 %i_12_2, i64 4, i1 false)
   br label %block7
}
