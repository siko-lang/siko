...
block4:
   ...
   call void @llvm.memcpy.p0.p0.i64(ptr align 4 %match_var_0, ptr align 4 %i_4_1, i64 0, i1 false)
   br label %block1
block5:
   br label %block6
block6:
   ...
   br label %block1
block7:
   call void @llvm.memcpy.p0.p0.i64(ptr align 4 %i_7_1, ptr align 4 %match_var_1, i64 0, i1 false)
   call void @Main_final(ptr %i_7_2)
   call void @siko_Tuple_(ptr %i_7_3)
   call void @llvm.memcpy.p0.p0.i64(ptr align 4 %fn_result, ptr align 4 %i_7_3, i64 0, i1 false)
   ret void
block8:
...
block10:
   ...
   call void @llvm.memcpy.p0.p0.i64(ptr align 4 %match_var_1, ptr align 4 %i_10_2, i64 0, i1 false)
   br label %block7
block11:
   br label %block12
block12:
   ...
   call void @llvm.memcpy.p0.p0.i64(ptr align 4 %match_var_1, ptr align 4 %i_12_2, i64 0, i1 false)
   br label %block7
}
