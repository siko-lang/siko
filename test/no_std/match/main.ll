...
block0:
   ...
   call void @llvm.memcpy.p0.p0.i64(ptr align 4 %f1, ptr align 4 %field1, i64 4, i1 false)
...
block7:
   ...
   call void @llvm.memcpy.p0.p0.i64(ptr align 8 %match_var_0, ptr align 8 %i_7_1, i64 8, i1 false)
   br label %block1
block8:
   br label %block9
block9:
   ...
   call void @llvm.memcpy.p0.p0.i64(ptr align 8 %match_var_0, ptr align 8 %i_9_1, i64 8, i1 false)
   br label %block1
block10:
   br label %block11
block11:
...
block15:
   ...
   call void @llvm.memcpy.p0.p0.i64(ptr align 8 %match_var_0, ptr align 8 %i_15_1, i64 8, i1 false)
   br label %block1
}
