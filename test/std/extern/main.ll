...
block0:
   %i_0_9 = alloca %struct.siko_Tuple_, align 4
   ...
   call void @siko_Tuple_(ptr %i_0_9)
   call void @llvm.memcpy.p0.p0.i64(ptr align 4 %fn_result, ptr align 4 %i_0_9, i8 0, i1 false)
   ret void
}
