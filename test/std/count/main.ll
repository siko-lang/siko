...
block0:
   ...
   %i_2_8 = alloca %struct.siko_Tuple_, align 4
...
block2:
   ...
   call void @siko_Tuple_(ptr %i_2_8)
   call void @llvm.memcpy.p0.p0.i64(ptr align 4 %fn_result, ptr align 4 %i_2_8, i8 0, i1 false)
   ret void
block4:
