...
block0:
   ...
   %tmp_literal_4_1 = getelementptr inbounds %struct.String_String, ptr %literal_4, i32 0, i32 0
   store ptr @.str_0, ptr %tmp_literal_4_1, align 8
   %tmp_literal_4_2 = getelementptr inbounds %struct.String_String, ptr %literal_4, i32 0, i32 1
   store i64 4, ptr %tmp_literal_4_2, align 8
   ...
   %tmp_literal_7_1 = getelementptr inbounds %struct.String_String, ptr %literal_7, i32 0, i32 0
   store ptr @.str_1, ptr %tmp_literal_7_1, align 8
   %tmp_literal_7_2 = getelementptr inbounds %struct.String_String, ptr %literal_7, i32 0, i32 1
   store i64 4, ptr %tmp_literal_7_2, align 8
   ...
   %tmp_literal_11_1 = getelementptr inbounds %struct.String_String, ptr %literal_11, i32 0, i32 0
   store ptr @.str_2, ptr %tmp_literal_11_1, align 8
   %tmp_literal_11_2 = getelementptr inbounds %struct.String_String, ptr %literal_11, i32 0, i32 1
   store i64 5, ptr %tmp_literal_11_2, align 8
   ...
   call void @String_String_eq(ptr %fieldRef_20, ptr %fieldRef_17, ptr %call_22)
