...
block0:
   %b0i32 = alloca %struct.siko_Tuple_, align 4
   %b0i31 = alloca %struct.siko_Tuple_, align 4
   %b0i29 = alloca %struct.Bool_Bool, align 4
   %b0i25 = alloca %struct.Main_Person, align 8
   %b0i21 = alloca %struct.Main_Person, align 8
   %person2_3 = alloca %struct.Main_Person, align 8
   %b0i19 = alloca %struct.Main_Person, align 8
   %b0i17 = alloca %struct.Main_Address, align 8
   %b0i15 = alloca %struct.String_String, align 8
   %person1_2 = alloca %struct.Main_Person, align 8
   %b0i13 = alloca %struct.Main_Person, align 8
   %b0i11 = alloca %struct.Main_Address, align 8
   %b0i9 = alloca %struct.String_String, align 8
   %addr2_1 = alloca %struct.Main_Address, align 8
   %b0i7 = alloca %struct.Main_Address, align 8
   %b0i5 = alloca %struct.String_String, align 8
   %addr1_0 = alloca %struct.Main_Address, align 8
   %b0i3 = alloca %struct.Main_Address, align 8
   ...
   call void @Main_Address(ptr %b0i1, ptr %b0i3)
   call void @llvm.memcpy.p0.p0.i64(ptr align 8 %addr1_0, ptr align 8 %b0i3, i64 16, i1 false)
   %tmp_b0i5_1 = getelementptr inbounds %struct.String_String, ptr %b0i5, i32 0, i32 0
   store ptr @.str_0, ptr %tmp_b0i5_1, align 8
   %tmp_b0i5_2 = getelementptr inbounds %struct.String_String, ptr %b0i5, i32 0, i32 1
   store i64 4, ptr %tmp_b0i5_2, align 8
   call void @Main_Address(ptr %b0i5, ptr %b0i7)
   call void @llvm.memcpy.p0.p0.i64(ptr align 8 %addr2_1, ptr align 8 %b0i7, i64 16, i1 false)
   %tmp_b0i9_1 = getelementptr inbounds %struct.String_String, ptr %b0i9, i32 0, i32 0
   store ptr @.str_1, ptr %tmp_b0i9_1, align 8
   %tmp_b0i9_2 = getelementptr inbounds %struct.String_String, ptr %b0i9, i32 0, i32 1
   store i64 4, ptr %tmp_b0i9_2, align 8
   call void @llvm.memcpy.p0.p0.i64(ptr align 8 %b0i11, ptr align 8 %addr1_0, i64 16, i1 false)
   call void @Main_Person(ptr %b0i9, ptr %b0i11, ptr %b0i13)
   call void @llvm.memcpy.p0.p0.i64(ptr align 8 %person1_2, ptr align 8 %b0i13, i64 32, i1 false)
   %tmp_b0i15_1 = getelementptr inbounds %struct.String_String, ptr %b0i15, i32 0, i32 0
   store ptr @.str_2, ptr %tmp_b0i15_1, align 8
   %tmp_b0i15_2 = getelementptr inbounds %struct.String_String, ptr %b0i15, i32 0, i32 1
   store i64 5, ptr %tmp_b0i15_2, align 8
   call void @llvm.memcpy.p0.p0.i64(ptr align 8 %b0i17, ptr align 8 %addr2_1, i64 16, i1 false)
   call void @Main_Person(ptr %b0i15, ptr %b0i17, ptr %b0i19)
   call void @llvm.memcpy.p0.p0.i64(ptr align 8 %person2_3, ptr align 8 %b0i19, i64 32, i1 false)
   call void @llvm.memcpy.p0.p0.i64(ptr align 8 %b0i21, ptr align 8 %person2_3, i64 32, i1 false)
   %b0i22 = getelementptr inbounds %struct.Main_Person, ptr %b0i21, i32 0, i32 1
   %b0i23 = getelementptr inbounds %struct.Main_Address, ptr %b0i22, i32 0, i32 0
   call void @llvm.memcpy.p0.p0.i64(ptr align 8 %b0i25, ptr align 8 %person1_2, i64 32, i1 false)
   %b0i26 = getelementptr inbounds %struct.Main_Person, ptr %b0i25, i32 0, i32 1
   %b0i27 = getelementptr inbounds %struct.Main_Address, ptr %b0i26, i32 0, i32 0
   call void @String_String_eq(ptr %b0i27, ptr %b0i23, ptr %b0i29)
   call void @Std_Basic_Util_assert(ptr %b0i29, ptr %b0i31)
   call void @siko_Tuple_(ptr %b0i32)
   call void @llvm.memcpy.p0.p0.i64(ptr align 4 %fn_result, ptr align 4 %b0i32, i64 0, i1 false)
   ret void
}
