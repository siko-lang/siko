...
block1:
   ...
   store i64 10, ptr %tmp_lit_7_1, align 8
...
block2:
   ...
   %tmp_lit_29_1 = getelementptr inbounds %struct.Int_Int, ptr %lit_29, i32 0, i32 0
   store i64 10, ptr %tmp_lit_29_1, align 8
   ...
   %tmp_lit_34_1 = getelementptr inbounds %struct.Int_Int, ptr %lit_34, i32 0, i32 0
   store i64 1, ptr %tmp_lit_34_1, align 8
   call void @llvm.memcpy.p0.p0.i64(ptr align 8 %loopVar_35, ptr align 8 %lit_34, i64 8, i1 false)
   br label %block9
block4:
   %tmp_switch_var_block4_1 = getelementptr inbounds %struct.Bool_Bool, ptr %call_10, i32 0, i32 0
...
block7:
   br label %block8
block8:
   %tmp_lit_18_1 = getelementptr inbounds %struct.Int_Int, ptr %lit_18, i32 0, i32 0
   store i64 1, ptr %tmp_lit_18_1, align 8
...
block9:
   ...
   %tmp_lit_40_1 = getelementptr inbounds %struct.Int_Int, ptr %lit_40, i32 0, i32 0
   store i64 10, ptr %tmp_lit_40_1, align 8
...
block10:
   ...
   %tmp_lit_61_1 = getelementptr inbounds %struct.Int_Int, ptr %lit_61, i32 0, i32 0
   store i64 10, ptr %tmp_lit_61_1, align 8
...
block11:
   ...
   br label %block9
block12:
   %tmp_switch_var_block12_1 = getelementptr inbounds %struct.Bool_Bool, ptr %call_43, i32 0, i32 0
...
block15:
   br label %block16
block16:
   %tmp_lit_51_1 = getelementptr inbounds %struct.Int_Int, ptr %lit_51, i32 0, i32 0
   store i64 1, ptr %tmp_lit_51_1, align 8
