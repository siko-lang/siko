...
block0:
   %b16i5 = alloca %struct.Int_Int, align 8
   %b16i3 = alloca %struct.Int_Int, align 8
   %b16i1 = alloca %struct.Int_Int, align 8
   %b14i1 = alloca %struct.Int_Int, align 8
   %b11i1 = alloca %struct.Int_Int, align 8
   %b10i10 = alloca %struct.siko_Tuple_, align 4
   %b10i9 = alloca %struct.siko_Tuple_, align 4
   %b10i7 = alloca %struct.Bool_Bool, align 4
   %b10i5 = alloca %struct.Int_Int, align 8
   ...
   %b9i7 = alloca %struct.Bool_Bool, align 4
   %b9i5 = alloca %struct.Int_Int, align 8
   %b9i3 = alloca %struct.Int_Int, align 8
   %a_5 = alloca %struct.Int_Int, align 8
   %b9i1 = alloca %struct.Int_Int, align 8
   %b8i5 = alloca %struct.Int_Int, align 8
   %b8i3 = alloca %struct.Int_Int, align 8
   %b8i1 = alloca %struct.Int_Int, align 8
   %b6i1 = alloca %struct.Int_Int, align 8
   %loop_var_4 = alloca %struct.Int_Int, align 8
   %b2i10 = alloca %struct.Int_Int, align 8
   %b2i9 = alloca %struct.siko_Tuple_, align 4
   %b2i7 = alloca %struct.Bool_Bool, align 4
   %b2i5 = alloca %struct.Int_Int, align 8
   ...
   %b1i7 = alloca %struct.Bool_Bool, align 4
   %b1i5 = alloca %struct.Int_Int, align 8
...
block1:
   ...
   call void @llvm.memcpy.p0.p0.i64(ptr align 8 %b1i5, ptr align 8 %a_1, i64 8, i1 false)
   call void @Int_Int_lessThan(ptr %b1i5, ptr %b1i3, ptr %b1i7)
   br label %block4
block2:
   ...
   call void @llvm.memcpy.p0.p0.i64(ptr align 8 %b2i5, ptr align 8 %r_3, i64 8, i1 false)
   call void @Int_Int_eq(ptr %b2i5, ptr %b2i3, ptr %b2i7)
   call void @Std_Basic_Util_assert(ptr %b2i7, ptr %b2i9)
   %tmp_b2i10_1 = getelementptr inbounds %struct.Int_Int, ptr %b2i10, i32 0, i32 0
   store i64 1, ptr %tmp_b2i10_1, align 8
   call void @llvm.memcpy.p0.p0.i64(ptr align 8 %loop_var_4, ptr align 8 %b2i10, i64 8, i1 false)
   br label %block9
block4:
   %tmp_switch_var_block4_1 = getelementptr inbounds %struct.Bool_Bool, ptr %b1i7, i32 0, i32 0
...
block8:
   ...
   call void @llvm.memcpy.p0.p0.i64(ptr align 8 %b8i3, ptr align 8 %a_1, i64 8, i1 false)
   call void @Int_Int_add(ptr %b8i3, ptr %b8i1, ptr %b8i5)
   call void @llvm.memcpy.p0.p0.i64(ptr align 8 %loop_var_0, ptr align 8 %b8i5, i64 8, i1 false)
   br label %block1
block9:
   ...
   call void @llvm.memcpy.p0.p0.i64(ptr align 8 %b9i5, ptr align 8 %a_5, i64 8, i1 false)
   call void @Int_Int_lessThan(ptr %b9i5, ptr %b9i3, ptr %b9i7)
   br label %block12
block10:
   ...
   call void @llvm.memcpy.p0.p0.i64(ptr align 8 %b10i5, ptr align 8 %r_7, i64 8, i1 false)
   call void @Int_Int_eq(ptr %b10i5, ptr %b10i3, ptr %b10i7)
   call void @Std_Basic_Util_assert(ptr %b10i7, ptr %b10i9)
   call void @siko_Tuple_(ptr %b10i10)
   call void @llvm.memcpy.p0.p0.i64(ptr align 4 %fn_result, ptr align 4 %b10i10, i64 0, i1 false)
   ret void
block11:
   ...
   br label %block9
block12:
   %tmp_switch_var_block12_1 = getelementptr inbounds %struct.Bool_Bool, ptr %b9i7, i32 0, i32 0
...
block16:
   ...
   call void @llvm.memcpy.p0.p0.i64(ptr align 8 %b16i3, ptr align 8 %a_5, i64 8, i1 false)
   call void @Int_Int_add(ptr %b16i3, ptr %b16i1, ptr %b16i5)
   call void @llvm.memcpy.p0.p0.i64(ptr align 8 %match_var_6, ptr align 8 %b16i5, i64 8, i1 false)
   br label %block11
}
